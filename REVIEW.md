...
审查代码是否符合 `.claude/rules/` 目录下的项目规范。
...
> 规范参考：`.claude/rules/ecs-architecture.md`
...
> 规范参考：`.claude/rules/npc-component.md`、`.claude/rules/ai-decision.md`、`.claude/rules/behavior-tree.md`
...
> 规范参考：`.claude/rules/sensor-system.md`、`.claude/rules/executor-system.md`
