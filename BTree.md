...
> 所有代码路径均相对于 `P1GoServer/` 目录，运行命令前需 `cd P1GoServer`。
...
**查看所有节点摘要**：
```bash
cd P1GoServer && go test -v ./servers/scene_server/internal/common/ai/bt/nodes/... -run TestNodeRegistryPopulated
```
...
cd P1GoServer && WRITE_NODE_DOC=1 go test ./servers/scene_server/internal/common/ai/bt/nodes/... -run WriteNodeDocToFile
```
